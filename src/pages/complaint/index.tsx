...
const ComplaintPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Store the ticket data in localStorage for demo purposes
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow container mx-auto px-4 py-6">
          <div className="max-w-3xl mx-auto mb-8">
            <h1 className="text-3xl font-bold mb-2">Sistem Pengaduan</h1>
            <p className="text-muted-foreground">
              Laporkan masalah, keluhan, atau saran untuk perbaikan layanan SMKN 1 Kendal
            </p>
