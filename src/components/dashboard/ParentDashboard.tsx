...
import { 
  Users, CalendarCheck, MessageSquare, ClipboardList, Bell, Shield, BookOpen, BookText
} from 'lucide-react';

// Stats for parent dashboard
const statsCards = [
  { label: 'Kehadiran Bulan Ini', value: '95%', status: 'positive' },
  { label: 'Tugas Tertunda', value: '3', status: 'warning' },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Link to="/parent-portal/academic" className="block">
          <Card className="hover:shadow-md transition-shadow h-full">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Pantau perkembangan akademik anak Anda</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link to="/parent-portal/assignments" className="block">
          <Card className="hover:shadow-md transition-shadow h-full">
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center text-lg">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Pantau tugas dan PR yang diberikan kepada anak</p>
            </CardContent>
          </Card>
        </Link>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Jadwal UTS Semester Genap telah ditetapkan</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-medium">Tugas Baru</h3>
                <p className="text-sm text-muted-foreground">Tugas Matematika diberikan, tenggat 3 hari lagi</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-medium">Penilaian Harian</h3>
                <p className="text-sm text-muted-foreground">Nilai ulangan Matematika: 85 (Baik)</p>
